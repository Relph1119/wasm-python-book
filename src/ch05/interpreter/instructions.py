...
@desc: 指令表
"""
from ch05.binary import opcodes
from ch05.interpreter.instr_control import call
from ch05.interpreter.instr_numeric import *
from ch05.interpreter.instr_parametric import drop, _select
