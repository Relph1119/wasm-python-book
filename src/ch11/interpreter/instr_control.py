...
@desc:
"""
from ch11.binary.opcodes import Call, Block, Loop, If
from ch11.interpreter import uint32
from ch11.interpreter.errors import ErrTrap, ErrUndefinedElem, ErrTypeMismatch
...
def pop_args(vm, ft):
    ...
    for i in range(param_count - 1, -1, -1):
        args[i] = wrap_u64(ft.param_types[i], vm.pop_u64())
    return args
