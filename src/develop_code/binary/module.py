...
from binary.instruction import Expr
from binary.types import TableType, MemType, GlobalType
...
class Global:
    ...
    def __init__(self, type=None, init=None):
        self.type = type
        self.init = init
...
class Code:
    ...
    def __init__(self, locals=None, expr=None):
        if locals is None:
            locals = []
        self.locals = locals
        self.expr = expr
