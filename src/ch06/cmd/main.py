...
from ch06 import binary
from ch06.cmd.dumper import dump
from ch06.interpreter.vm import exec_main_func
...
if __name__ == '__main__':
    ...
    file_name = os.path.join(os.path.dirname(root_path), "../wat", "ch06_mem.wasm")
    fake_args = [file_name]
    main(fake_args)
